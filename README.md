...
| `karbonn` | `coola`        | `numpy`<sup>*</sup> | `objectory`<sup>*</sup> | `pytorch-ignite`<sup>*</sup> | `tabulate`<sup>*</sup> | `torch`       | `python`      |
|-----------|----------------|---------------------|-------------------------|------------------------------|------------------------|---------------|---------------|
| `main`    | `>=0.8.1,<1.0` | `>=1.22,<3.0`       | `>=0.1,<1.0`            | `>=0.4.11,<1.0`              | `>=0.9,<0.10`          | `>=1.10,<3.0` | `>=3.9,<3.13` |
